        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                actionBar.addView(communityAvatarImage, LayoutHelper.createFrame(32, 32, Gravity.BOTTOM | Gravity.LEFT, 58, 0, 0, 12f));
                 ...
                 AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(null, dp(26)); statusDrawable.center = true; actionBar.setTitle("امیررضا گرام", statusDrawable); updateStatus(UserConfig.getInstance(currentAccount).getCurrentUser(), false);           }
            if (folderId == 0) {
